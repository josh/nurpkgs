...
rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
    owner = "pimalaya";
    repo = "himalaya";
    rev = "791a54ef153ccb8170e8d6c64678fe50d61723ae";
    hash = "sha256-A/G2nGOU1/823A9QbGx8XwE97ErbVZDe8Q6K4jGgZfM=";
  };

  cargoHash = "sha256-VZATqG0qAKaxYuSJDQIAW4skeMUmphRGVto4+OkPEUs=";
