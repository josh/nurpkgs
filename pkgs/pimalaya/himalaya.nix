...
rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
    owner = "pimalaya";
    repo = "himalaya";
    rev = "ef45901b75a55bdcb33e548c6b69cf76f9ef32d5";
    hash = "sha256-mbqzeNLnyfU0rr4cazRmh47WifW+ydeX7hxvdmR2QyY=";
  };

  cargoHash = "sha256-cIa8c3vWtZirOAG+GuRy7ovohTat54ZQL2MnzQXBwME=";
