...
rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
    owner = "pimalaya";
    repo = "himalaya";
    rev = "1f6cf0616602a32575e9c258153bc6bc2e2d3856";
    hash = "sha256-vjBxYuP+rh7ZT0plcm+Y1foNjuB30EX/g6O2zvy8ayI=";
  };

  cargoHash = "sha256-EVtnjLVjc7KcQBpX+pk1AXr1WaOZABcfEm1tktvDj5Q=";
