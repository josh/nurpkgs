...
rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
    owner = "pimalaya";
    repo = "himalaya";
    rev = "ad747e5924be29a6d755d1a9d68794bcff1d07fc";
    hash = "sha256-WCOLwYBrv6TeE+IkwGB5oSIhxOOtE3Itgtn3c64z090=";
  };

  cargoHash = "sha256-2fY4wECwKU3PDsoR5rVeqYD+1MCPow6s62iTCN5FOwU=";
